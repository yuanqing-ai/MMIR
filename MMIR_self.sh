...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 /workspace/pytorch-i3d/train_i3d.py  --train=True --results_path="EPIC_"$sourcedomain"_"$targetdomain"_mmsada_pretrain_self_nobn"  \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 /workspace/pytorch-i3d/train_i3d.py  --train=True --results_path="EPIC_"$sourcedomain"_"$targetdomain"_mmsada_self_nobn"   \
                           --trained_path="EPIC_"$sourcedomain"_"$targetdomain"_mmsada_pretrain_self_nobn/saved_model_"$sourcedomain"_"$targetdomain"_0.01_0.9/004001.pt" \
                           ...
                           --steps_before_update 1 --restore_mode="model" --domain_mode="PretrainM" --epoch=200 --pred_synch=True --self_lambda=1.0
