...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 /workspace/pytorch-i3d/train_i3d.py  --train=True --results_path="EPIC_"$sourcedomain"_"$targetdomain"_mmsada_DAonly"   \
                           ...
                           --steps_before_update 1 --restore_mode="model" --domain_mode="DANN" --epoch=200 --lambda_in=0.2 #--pred_synch=True