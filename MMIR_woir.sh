...
# CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 /workspace/pytorch-i3d/train_i3d.py  --train=True --results_path="EPIC_"$sourcedomain"_"$targetdomain"_mmsada_pretrain_mmirwoir"  \
...
#                            --epoch=100 --pred_synch=True    #--trained_path="/workspace/pytorch-i3d/trained_model/012000.pt" 
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 /workspace/pytorch-i3d/train_i3d.py  --train=True --results_path="EPIC_"$sourcedomain"_"$targetdomain"_mmsada_mmir"   \
                           --trained_path="EPIC_"$sourcedomain"_"$targetdomain"_mmsada_pretrain_self/saved_model_"$sourcedomain"_"$targetdomain"_0.01_0.9/004001.pt" \
                           ...
                           --steps_before_update 1 --restore_mode="model" --domain_mode="DANN" --lambda_in=0.2  --self_lambda=1.0 --epoch=200 \
                           --pred_synch=True
